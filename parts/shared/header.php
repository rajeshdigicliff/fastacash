<header class="mainHeader" role="banner">
	...
	<h1 class="headerLogo <?php if(!is_front_page()) echo 'subpage'; ?>"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_stylesheet_directory_uri(); echo $logoname;?>" alt="Fastacash" /></a></h1>
	<nav class="mainNav">
		<label for="openMenu">
